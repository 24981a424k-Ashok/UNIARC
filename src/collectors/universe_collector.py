...
class UniverseCollector:
    ...
    async def fetch_country_news(self, country: str) -> Dict[str, Any]:
        ...
        # 6. Structure into Dashboard Categories - INCREASED Quantities
        structured_data = {
            "top_stories": analyzed_news[5:17], # Up to 12 stories
            "breaking_news": analyzed_news[:5], # Top 5 for carousel
